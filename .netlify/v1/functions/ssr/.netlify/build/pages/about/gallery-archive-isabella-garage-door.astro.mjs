...
const $$GalleryArchiveIsabellaGarageDoor = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$GalleryArchiveIsabellaGarageDoor;
  const title = "Archive | Isabella Garage Door";
  const description = "Browse our archive of past garage door projects showcasing craftsmanship and quality work across Central Michigan.";
  const posts = [
...
Browse our project archive — proof of our commitment to quality and detail across Central Michigan homes.
</p> <p style="font-size: .9rem; text-align: center; margin: 0.5rem;"> <em>Raising Performance. Elevating Standards</em> </p> </section> ${renderScript($$result2, "C:/Users/Amanda/Documents/Peters-Files/isabella-garage-door/src/pages/about/gallery-archive-isabella-garage-door.astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result2, "C:/Users/Amanda/Documents/Peters-Files/isabella-garage-door/src/pages/about/gallery-archive-isabella-garage-door.astro?astro&type=script&index=1&lang.ts")} ` })}`;
}, "C:/Users/Amanda/Documents/Peters-Files/isabella-garage-door/src/pages/about/gallery-archive-isabella-garage-door.astro", void 0);

const $$file = "C:/Users/Amanda/Documents/Peters-Files/isabella-garage-door/src/pages/about/gallery-archive-isabella-garage-door.astro";
const $$url = "/about/gallery-archive-isabella-garage-door";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$GalleryArchiveIsabellaGarageDoor,
  file: $$file,
  url: $$url
