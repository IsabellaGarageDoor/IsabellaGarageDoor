...
const $$NewDoorInstallation = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "description": description }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<img src="/photos/newly-installed-garage-door.webp" alt="A Newly Installed Garage Door in Alma Michigan" loading="eager" fetchpriority="high" class="header-photo-interior"> <section> <h1 class="page-title">Beautiful, Reliable New Garage Doors</h1> <p class="hero-description">
